    ...
    return (
      <div>
        ...
        <p>
          ...
          algorithms are then run on these huge images to find the relevant
          parts of the train for inspections.
        </p>
        <p>
          For this problem you will be looking at developing algorithms to find
        ...
        <p>You should think creatively about</p>
        ...
        <div className="DataButtons">
          ...
          <Button color="primary">
            Wheels <i className={['fas', 'fa-download'].join(' ')} />
          </Button>
        </div>
        <p>
          ...
          highly unlikely that there are incorrectly labeled images. The number
          of images in each category is broken down in the table below:
        </p>
        ...
        <p>
          For <b>Wheels</b> the zip contains two sub folders: <i>all_wheels</i>{' '}
          and <i>defect_wheels</i>. None of the images are equalized, each image
          is exactly as captured. The distribution of labels is not balanced at
          all and there is a good chance of defects being contained in the{' '}
          <i>all_wheels</i> folder. The number of images in each category is
