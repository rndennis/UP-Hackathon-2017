    ...
    return (
      <Paper>
        <div>
          ...
          <p>
            Every team will be required to commit to a problem by 1:40pm Saturday. 
            The problem that you commit to by this time will be the problem you must present Sunday morning. 
            To commit to a problem let a volunteer know your team name and the problem you're going to work on either 
            by messaging them on the Discord or finding one of them in person. 
          </p>
          <p>
          ...
          <ul className="UnstyledList">
            <li>
              ...
              <span>
                The project implementation presents and elegant, efficient, and clean solution.
              </span>
            </li>
            <li>
              <span className="Label">
              ...
              <span>
                The project is in a highly developed, finished, or refined state.
              </span>
            </li>
            <li>
              <span className="Label">
          ...
          <p>
            Each category will be assigned a score of 0-10.
          </p>
          <p>
          ...
          <ul className="UnstyledList">
            <li>
              <span className="Label">
                Problem Prize Winners
              </span>
              <span>
                The team with the highest score in each problem.
              </span>
            </li>
            <li>
              <span className="Label">
              ...
              <span>
                All three of the Problem Prize Winners will reviewed by all judges and ordered 1st-3rd. 
                The team with the most 1st choices will be declared the Grand Prize Winner and the second place team in that 
                problem will become the Problem Prize Winner for the respective problem.
              </span>
            </li>
          </ul>
